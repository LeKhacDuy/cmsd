  ...
  "posts": [
    {
      ...
      "translations": [
        { "locale": "vi", "slug": "chinh-sach-visa-eb5-moi-nhat-2026" },
        { "locale": "en", "slug": "eb5-visa-policy-2026" }
      ],
      ...
      "country": { "name": "Hoa Kỳ", "slug": "hoa-ky", "flagIcon": "🇺🇸" }
    }
  ],
  "pagination": {
    "total": 25,
...
> - `translations`: Mảng chứa **tất cả slug của các bản dịch** — FE dùng để chuyển ngôn ngữ không cần gọi thêm API.
>
> **Flow chuyển ngôn ngữ:**
> 1. FE đang xem bài VI, đọc `translations` từ response
> 2. Tìm phần tử có `locale = "en"` → lấy `slug` đó redirect sang trang EN
> 3. Không cần gọi thêm API nào
  ...
  "programs": [
    {
      ...
      "translations": [
        { "locale": "vi", "slug": "visa-eb5-my" },
        { "locale": "en", "slug": "eb5-visa-program" }
      ],
      "excerpt": "Đầu tư $800,000 lấy thẻ xanh Mỹ cho cả gia đình.",
      "featuredImage": "https://example.com/image.jpg",
      "sortOrder": 1,
      "serviceGroup": { "name": "Đầu tư & Định cư Mỹ", "slug": "dinh-cu-my" },
      "country": { "name": "Hoa Kỳ", "slug": "hoa-ky", "flagIcon": "🇺🇸" }
    }
  ]
}
  ...
  "data": [
    {
      ...
      "translations": [
        { "locale": "vi", "slug": "du-an-eb5-mother-gaston" },
        { "locale": "en", "slug": "eb5-mother-gaston-project" }
      ],
      "excerpt": "Dự án EB-5 an toàn, vùng TEA, hoàn vốn sau 2 năm.",
      "featuredImage": "https://example.com/image.jpg",
      "availability": "AVAILABLE",
      "createdAt": "2026-03-01T06:00:00.000Z",
      "program": { "name": "Visa EB-5: Định cư Mỹ", "slug": "visa-eb5-my" }
    }
  ]
}
```
