...
export default function ProjectForm({ programs }: { programs: Program[] }) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setToast({ type: 'success', message: 'Tạo dự án thành công!' });
            setTimeout(() => router.push('/admin/projects'), 1000);
        } catch {
            setToast({ type: 'error', message: 'Lỗi khi tạo dự án' });
        } finally {
            setLoading(false);
        }
    };
                ...
                <form onSubmit={handleSubmit} className="form-page">
                    ...
                    <div className="form-card">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="name" className="form-input" placeholder="VD: Dự án Mother Gaston..." required />
                        </div>
                        <div className="form-group">
                    ...
                    <div className="form-card">
                        ...
                        <div className="form-row">
                            <div className="form-group">
                                ...
                                <select name="programId" className="form-select" required>
                    ...
                    <div className="form-actions">
                        <button type="submit" className="btn btn-primary" style={{ width: 'auto' }} disabled={loading}>
                            {loading ? <><span className="spinner" /> Đang lưu...</> : 'Tạo dự án'}
                        </button>
